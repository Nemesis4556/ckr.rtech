...
// ============================================
    ...
    // ============================================
    // 6. SCROLL REVEAL — IntersectionObserver (Lightweight)
    // ============================================
    function initScrollReveal() {
        ...
        const revealElements = document.querySelectorAll(
            ...
            '.pricing-card, .testimonial-card, .insight-card, .blog-card, ' +
            '.faq-item, .vision-card, .client-logo'
        );

        if (revealElements.length === 0) return;

        // Batch all reveals under a single observer for performance
    ...
    function initScrollReveal() {
        ...
        const revealElements = document.querySelectorAll(
            '.service-card, .portfolio-item, .process-step, .team-card, ' +
            '.pricing-card, .testimonial-card, .insight-card, .blog-card, ' +
            '.faq-item, .vision-card, .client-logo'
        );
